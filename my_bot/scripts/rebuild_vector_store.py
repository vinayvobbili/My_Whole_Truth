...
def restart_preloader():
    ...
    try:
        if platform.system() == "Darwin":  # macOS
            ...
            # Stop the service
            subprocess.run(["launchctl", "stop", "com.metlife.soc-bot-preloader"],
                           check=False, capture_output=True)
            # Start the service
            subprocess.run(["launchctl", "start", "com.metlife.soc-bot-preloader"],
        ...
        print("   macOS: launchctl stop/start com.metlife.soc-bot-preloader")
