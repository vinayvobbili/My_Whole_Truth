...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    cat > ~/Library/LaunchAgents/com.metlife.soc-bot-preloader.plist << EOF
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
    <key>Label</key>
    <string>com.metlife.soc-bot-preloader</string>
...
EOF
    ...
    # Load the service
    launchctl load ~/Library/LaunchAgents/com.metlife.soc-bot-preloader.plist
    
    echo "✅ Service installed and loaded!"
    echo "📋 Available commands:"
    echo "   • Start:   launchctl start com.metlife.soc-bot-preloader"
    echo "   • Stop:    launchctl stop com.metlife.soc-bot-preloader"
