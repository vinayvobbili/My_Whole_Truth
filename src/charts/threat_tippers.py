...
def make_chart():
    try:
        threat_tippers = azdo.get_stories_from_area_path("Detection-Engineering\\DE Rules\\Threat Hunting")  # the area path is correct even though it says Threat Hunting
